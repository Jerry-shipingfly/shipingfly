...
export const MOCK_USERS: AuthUser[] = [
  {
    ...
    name: 'Demo User',
    avatar: '/assets/images/avatars/avatar-demo.svg',
    role: 'admin',
  ...
  },
  {
    ...
    name: 'Seller Zhang',
    avatar: '/assets/images/avatars/avatar-seller.svg',
    role: 'seller',
  ...
  },
  {
    ...
    name: 'Buyer Li',
    avatar: '/assets/images/avatars/avatar-buyer.svg',
    role: 'user',
  ...
  },
  {
    ...
    name: 'Manager Wang',
    avatar: '/assets/images/avatars/avatar-manager.svg',
    role: 'manager',
