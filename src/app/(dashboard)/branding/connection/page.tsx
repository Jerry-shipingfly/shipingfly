/**
 * Packaging Connection Page
 * @description Manage packaging connections for Products, Orders, and Stores
 */
...
export default function PackagingConnectionPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        breadcrumb={[
          { label: t('nav.branding'), href: '/branding/packaging' },
          { label: t('branding.packagingConnection') },
        ]}
        backHref="/branding/packaging"
        actions={
